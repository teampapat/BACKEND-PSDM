                      ...
                      <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                        <div class="card card-tale">
                          <div class="card-body">
                            ...
                            <a class="small text-white stretched-link" id="menuGuruMapel" href="<?=BASEURL;?>/profilGuru/guruMapel">Lihat Detail</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                        <div class="card card-light-blue">
                          <div class="card-body">
                            ...
                            <p>Guru yang mengajar</p>
                            <a class="small text-white stretched-link" id="menuGuruProduktif" href="<?=BASEURL;?>/profilGuru/guruProduktif">Lihat Detail</a>
                          </div>
                        </div>
                      </div>
                    </div>
